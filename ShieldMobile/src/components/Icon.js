...
// Icônes SVG locales — aucune dépendance internet
import React from 'react';
import Svg, { Path, Circle, Rect, Polyline, Line, Polygon } from 'react-native-svg';

const d = (size, color) => ({ width: size, height: size, color });

export function IconShield({ size = 24, color = '#4a7223' }) {
  return (
...
export function IconShieldCheck({ size = 24, color = '#10b981' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        d="M12 2L3 7v5c0 5.25 3.75 10.15 9 11.25C17.25 22.15 21 17.25 21 12V7L12 2z"
...
export function IconHome({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function IconSearch({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconCamera({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function IconBell({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function IconSettings({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconFile({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function IconDownload({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconZap({ size = 24, color = '#f59e0b' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Polygon
...
export function IconZapOff({ size = 24, color = '#6b7280' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M13 2L3 14h9l-1 8 8-12h-7L13 2z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <Line x1="2" y1="2" x2="22" y2="22" stroke={color} strokeWidth="2" strokeLinecap="round" />
    </Svg>
  );
}

export function IconImage({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconFolderOpen({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function IconCheckCircle({ size = 24, color = '#10b981' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconChevronDown({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconChevronRight({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconArrowLeft({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconRefresh({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconCalendar({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconUser({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconWifi({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M5 12.55a11 11 0 0114.08 0" stroke={color} strokeWidth="2" strokeLinecap="round" />
      <Path d="M1.42 9a16 16 0 0121.16 0" stroke={color} strokeWidth="2" strokeLinecap="round" />
...
export function IconShare({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconTrendingUp({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function IconClock({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Circle cx="12" cy="12" r="10" stroke={color} strokeWidth="2" />
...
export function IconQrCode({ size = 24, color = '#4a7223' }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
