...
function KeyCard({ k }: { k: CryptographicKey }) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-800 rounded-xl p-4 bg-white dark:bg-slate-900">
      ...
      <div className="mt-3 p-3 rounded-lg bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700">
        <p className="text-[10px] text-slate-400 dark:text-slate-500 mb-1 font-medium uppercase tracking-wide">
          Clé publique
        </p>
        <p className="text-[10px] font-mono text-slate-600 dark:text-slate-400 break-all leading-relaxed line-clamp-3">
          {k.cle_publique}
        </p>
      </div>
